...
public class TestBackPackDb extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
        ...
        rowId = db.insert(UserBackpackContract.UserBackpackEntry.TABLE_NAME_GUEST, null, testValues);
        ...
        // A cursor is your primary interface to the query results.
        cursor = db.query(
                UserBackpackContract.UserBackpackEntry.TABLE_NAME_GUEST,  // Table to Query
                null, // leaving "columns" null just returns all the columns.
                null, // Columns for the "where" clause
                null, // Values for the "where" clause
                null, // columns to group by
    ...
    static ContentValues createValues() {
        ...
        values.put(UserBackpackContract.UserBackpackEntry.COLUMN_POSITION, 1);
